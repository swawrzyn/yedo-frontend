      ...
      wx.getSystemInfo({
        ...
        success: function(res) {
          if(res.platform === 'android') {
            ...
            meal_time = `${mealDateObj.getHours() < 10 ? '0' + mealDateObj.getHours() : mealDateObj.getHours()}:${mealDateObj.getMinutes() < 10 ? '0' + mealDateObj.getMinutes() : mealDateObj.getMinutes()}`
          } else {
