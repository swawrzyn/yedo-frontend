    ...
    oldMeals.forEach(oldmeal => {
      let meal_date;
          ...
          if(platform === 'android') {
            ...
            meal_time = `${oldmeal.meal_date.getHours() < 10 ? '0' + oldmeal.meal_date.getHours() : oldmeal.meal_date.getHours()}:${oldmeal.meal_date.getMinutes() < 10 ? '0' + oldmeal.meal_date.getMinutes() : oldmeal.meal_date.getMinutes()}`
          } else {
    ...
    newMeals.forEach(newmeal => {
      let meal_date;
          ...
          if(platform === 'android') {
            ...
            meal_time = `${newmeal.meal_date.getHours() < 10 ? '0' + newmeal.meal_date.getHours() : newmeal.meal_date.getHours()}:${newmeal.meal_date.getMinutes() < 10 ? '0' + newmeal.meal_date.getMinutes() : newmeal.meal_date.getMinutes()}`
          } else {
